defmodule ShinobiWeb.UserLive.SettingsTest do
  ...
  describe "confirm email" do
    ...
    test "does not update email by token when email delivery is disabled", %{
      conn: conn,
      user: user
    } do
      ...
      assert message == "Email confirmation links are disabled."
